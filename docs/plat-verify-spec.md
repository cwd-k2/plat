...
|---------|-----|-----------|------|
| `field_case` | `camelCase` | `camelCase` | `snake_case` |
...
| Interface methods | `type_declaration` > `interface_type` > `method_spec` | `interface_declaration` > `object_type` > `method_signature` | `trait_item` > `declaration_list` > `function_signature_item` |
