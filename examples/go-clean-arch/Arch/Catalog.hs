module Arch.Catalog (product_, category, productRepo, inventoryChecker, createProduct, getProduct, searchProducts, pgProductRepo, stubInventory, declareAll) where
