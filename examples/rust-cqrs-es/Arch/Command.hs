module Arch.Command (openAccount, depositMoney, withdrawMoney, closeAccount, freezeAccount, unfreezeAccount, declareAll) where
...
import Arch.Layers
import Arch.Domain (accountId, money, accountOpened, moneyDeposited, moneyWithdrawn, accountClosed, accountFrozen, accountUnfrozen)
